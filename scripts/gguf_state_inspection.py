    ...
    *,
    ...
    return {
        ...
        "requested_state": {
            ...
            "backend": "gguf",
            "quantizer": requested_type.lower(),
            "bits": None,
        ...
        "observed_state": {
            "precision": detected_type.lower() if detected_type else "unknown",
            "backend": "gguf",
            "loader_mode": "llama_cpp_server",
            "quantization_verified": not reasons,
        },
        ...
        "quantization": {
            ...
            "requested_backend": "gguf",
            "observed_backend": "gguf" if detected_type else "",
            "requested_bits": None,
            "observed_bits": None,
            "requested_quant_type": requested_type,
            "observed_quant_type": detected_type or None,
            "backend_config": {
                "quantization_type": requested_type,
                "llama_cpp_version": server_version,
            },
