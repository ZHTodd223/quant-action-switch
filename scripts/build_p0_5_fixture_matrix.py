...
def main() -> None:
    ...
    summary_specs = [
        ...
        ("raw_hash_bf16", {"kind":"raw_hash_mismatch","arm":"bf16"}, False, "RAW_OUTPUT_HASH_MISMATCH"),
        ("raw_hash_quant", {"kind":"raw_hash_mismatch","arm":"quant"}, False, "RAW_OUTPUT_HASH_MISMATCH"),
