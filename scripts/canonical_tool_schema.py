...
def scorer_identity(
    ...
    *,
    protocol_id: str = "agent_toolcall_protocol_v4_comparison_eligibility",
) -> dict[str, str]:
    evidence_class = (
        "CANONICAL_V5"
